...
function cptui_register_my_cpts_annonce() {
	...
	$labels = [
		"name" => __( "Annonces", "hello-elementor" ),
		"singular_name" => __( "Annonce", "hello-elementor" ),
	];

	$args = [
		"label" => __( "Annonces", "twentytwenty" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
...
function cptui_register_my_cpts_faq() {
	...
	$labels = [
		"name" => __( "faq", "twentytwenty" ),
		"singular_name" => __( "faq", "twentytwenty" ),
